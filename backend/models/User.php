...
class User extends \yii\db\ActiveRecord
{
    ...
    {
	   $profile_image = $fWebPath=$_SERVER["HTTP_HOST"].'rkpms/upload/profile/'.$id ? true :false;
	   return Yii::getAlias('')."/rkpms/upload/profile/".(($profile_image) ? $id : "no_images_view_profile.png");
    }
