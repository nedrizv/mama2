...
class AccountController extends Controller
{
    ...
    public function actionStatement()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            echo "<body>";
            $header_str=array("Sr.No","Date","R/No.","Description","Sale","Payment","Balance");	
            $noRows=count($header_str);
            ?>
                <table width="580" border="0" cellpadding="0" style="font-size:12px;" cellspacing="0" bordercolor="#666666">
                    <tr>
                        <td align="center" colspan="<?php echo $noRows;?>"><h3>STATEMENT OF ACCOUNT</h3></td>
                    </tr>
                    <tr>
                ...
                <table width="780" border="1" cellpadding="0" style="font-size:12px;" cellspacing="0" bordercolor="#666666">
                    ...
                    <?php
                        ...
                        foreach($accounts AS $account)
                        {
                            ...
                            $paymentAmt=0;
                            $returnAmt=0;
                            if(strtolower($account->description_type)=="pay")
                            {
