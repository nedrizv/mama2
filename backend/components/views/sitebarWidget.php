    ...
    <div class="menu_section">
        <ul>
            ...
            <li title="Users" <?php if(strtolower(Yii::$app->controller->id)=='user') { echo 'class="current_section"';}?>>
                <?= Html::a('<span class="menu_icon"><i class="material-icons"></i></span><span class="menu_title">Users</span>', ['/user']) ?>
            </li>
			
            <li title="Customer" <?php if(strtolower(Yii::$app->controller->id)=='customer') { echo 'class="current_section"';}?>>
                <?= Html::a('<span class="menu_icon"><i class="material-icons"></i></span><span class="menu_title">Manage Customers</span>', ['/customer']) ?>
            </li>
            ...
            <li title="Account" <?php if(strtolower(Yii::$app->controller->id)=='account' && strtolower(Yii::$app->controller->action->id)!='statement') { echo 'class="current_section"';}?>>
                <?= Html::a('<span class="menu_icon"><i class="material-icons"></i></span><span class="menu_title">Manage Accounts</span>', ['/account']) ?>
            </li>

            <li title="Account Statement" <?php if(strtolower(Yii::$app->controller->action->id)=='statement') { echo 'class="current_section"';}?>>
                <?= Html::a('<span class="menu_icon"><i class="material-icons"></i></span><span class="menu_title">Account Statement</span>', ['/account/statement']) ?>
            </li>
